...
function system.getCurrentScriptLocalization()
	return system.getLocalization(filesystem.path(system.getCurrentScript()) .. "Windows/Localizations/")
end
...
function system.updateDesktop()
	...
	local MineOSContextMenu = desktopMenu:addContextMenuItem("Windows", 0xF0F0F0)
